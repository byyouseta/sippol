...
class PelaporController extends Controller
{
    ...
    public function passupdate($id, Request $request)
    {
        ...
        */
        ...
        if (Hash::check($request->old_password, $user->password)) {
            ...
            Alert::success('Warning', 'Password lama tidak sama dengan didata');
    ...
    public function history()
    {
        ...
        // dd($data);
        return view('user.history_laporan', [
            'data' => $data,
            'data2' => $data2,
        ]);
    }
    ...
    public function manual()
    {
        ...
        $data = Pelaporan::all();
        return view('user.unggah', compact('data'));
    }
    ...
    public function manualstore(Request $request)
    {
        $this->validate($request, [
            ...
            'file_bukti' => 'mimes:jpg,jpeg|max:1028',
        ]);
    ...
    public function detailmanual($id)
    {
        ...
        //dd($data);
        return view('user.detail_manuallapor', [
            'data' => $data,
            'data2' => $data2,
        ]);
    }
    ...
    public function datadukung($file)
    {
        // Force download of the file
        $this->file_to_download   = 'file_catatan/' . $file;
        //return response()->streamDownload(function () {
        //    echo file_get_contents($this->file_to_download);
        //}, $file.'.pdf');
        return response()->file($this->file_to_download);
