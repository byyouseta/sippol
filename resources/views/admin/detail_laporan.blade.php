                ...
                <div class="modal fade" id="modal-aksi">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="/catatan/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>Balasan</label>
                                        <textarea class="form-control" rows="3" placeholder="Isikan catatan disini" name="catatan"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Upload Dokumen / Bukti (Jika Ada) </label>
                                        <input type="file" id="exampleInputFile" name="file">
                                        <p class="help-block">File yang dapat diupload adalah file jpg/jpeg/png dengan
                                            max file 2MB
                                        </p>
