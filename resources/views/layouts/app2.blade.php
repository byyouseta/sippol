...
<title>SIPPOL RSUP Surakarta | @if (Auth::user()->level == 1) Admin @else User
        @endif Dashboard</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Favicons -->
    <link href="{{ asset('assets/img/sippol-logo.png') }}" rel="icon">
    <!-- Bootstrap 3.3.7 -->
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg">
                    <img src="{{ asset('assets/img/sippol.jpeg') }}" class="img-circle" style="width: 40px">
                    <b>SIPPOL</b>RSUP
                </span>
            </a>
            ...
            <nav class="navbar navbar-static-top">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                @if (isset(Auth::user()->foto))
                                    <img src="{{ asset('foto_profil/' . Auth::user()->foto) }}" class="user-image"
                                        alt="User Image">
                                @else
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    @else
                                        <img src="{{ asset('adminlte/dist/img/avatar04.png') }}"
                                            class="img-circle" alt="User Image">
                                    @endif
                ...
                <!-- /.row -->
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="/password" class="btn btn-default btn-flat"><i
                                                class="fa fa-user"></i>
                                            Ubah Password</a>
                                    </div>
