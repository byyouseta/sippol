                        ...
                        <div class="col-md-6">
                            <form role="form" action="/lapor/store" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="alamat_kantor">{{ old('alamat_kantor') }}</textarea>
                                    @error('alamat_kantor')
                                        <span class="invalid-feedback text-red" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tempat_terima"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Uraian</label>
                                <textarea class="form-control" name="uraian_peristiwa">{{ old('uraian_peristiwa') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Harga/Nilai Nominal/Taksiran (Dalam Rupiah)</label>
                ...
                <div class="tab-pane" id="tab_3">
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Alamat</label>
                                <textarea class="form-control" name="alamat_pemberi">{{ old('alamat_pemberi') }}</textarea>
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="dokumen">
                                    ...
                                    <option value="Tidak Ada" @if (old('dokumen') == 'Tidak Ada') selected @endif>Tidak Ada
                                    </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="kronologi" rows="3">{{ old('kronologi') }}</textarea>
                                @error('kronologi')
                                    <span class="invalid-feedback text-red" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
