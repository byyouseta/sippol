                ...
                <form role="form" action="/lapor/manual/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Unggah Dokumen Pelaporan</label>
                            ...
                            <div class="form-group">
                                <label>Unggah Bukti Pendukung (Jika Ada)</label>
                                <input type="file" id="exampleInputFile" name="file_bukti">
                                <p class="help-block">File yang dapat diupload adalah file JPG/JPEG dengan max file 1MB
                                </p>
