...
Route::get('/lapor/manual/bukti/{id}', 'PelaporController@bukti');
Route::get('/lapor/manual/datadukung/{id}', 'PelaporController@datadukung');
//ajax
...
Route::middleware('cekstatus')->group(function () {
    ...
    Route::get('/pengguna/resetpassword/{id}', 'PenggunaController@resetpass');

    //MasterdataPelaporan
    Route::get('/pelaporan/list', 'PelaporanController@index');
